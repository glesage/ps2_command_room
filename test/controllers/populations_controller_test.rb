...
class PopulationsControllerTest < ActionController::TestCase
  ...
  test "should create population" do
    assert_difference('Population.count') do
      post :create, population: { NC: @population.NC, TR: @population.TR, VS: @population.VS, map_id: @population.map_id }
    end
  ...
  test "should update population" do
    patch :update, id: @population, population: { NC: @population.NC, TR: @population.TR, VS: @population.VS, map_id: @population.map_id }
    assert_redirected_to population_path(assigns(:population))
  end
