...
class PromotionsControllerTest < ActionController::TestCase
  ...
  test "should create promotion" do
    assert_difference('Promotion.count') do
      post :create, promotion: { description: @promotion.description, end_date: @promotion.end_date, image_path: @promotion.image_path, start_date: @promotion.start_date, title: @promotion.title }
    end
  ...
  test "should update promotion" do
    patch :update, id: @promotion, promotion: { description: @promotion.description, end_date: @promotion.end_date, image_path: @promotion.image_path, start_date: @promotion.start_date, title: @promotion.title }
    assert_redirected_to promotion_path(assigns(:promotion))
  end
